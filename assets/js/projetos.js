      ...
      <div class="cards">
        <div class="card">
          ...
          <div class="img-wrapper">
            <img
              src="./assets/images/projects/x-devs.gif"
        ...
        <div class="card">
          <h3>Página de Cadastro X</h3>
          <div class="img-wrapper">
            <img src="./assets/images/projects/x-cadastro.png" alt="Imagem do projeto." />
            <div class="buttons">
              <a href="https://github.com/victormattos564/1TDS1UserRegister" target="_blank" title="Repositório no Github">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
                  width="24"
              ...
              <a href="https://1-tds-1-user-register.vercel.app/" target="_blank" title="Ver Projeto">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
                  width="24"
          ...
          <p>Este projeto foi desenvolvido para praticar a criação de formulários e validação de dados no front-end.</p>
          <p>HTML - CSS - JS</p>
        </div>
        <div class="card">
